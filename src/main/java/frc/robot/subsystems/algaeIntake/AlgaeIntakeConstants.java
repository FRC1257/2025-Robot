...
public class AlgaeIntakeConstants {
    public static class AlgaeIntakeSimConstants {
      ...
      public static final double kMomentOfInertia = 0.5 * kCarriageMass * kAlgaeIntakeDrumRadius * kAlgaeIntakeDrumRadius; // Moment of inertia represents how resistant to force something is

    }

    public static class AlgaeIntakePhysicalConstants {
      public static final double kAlgaeIntakeP = 0.001;
      public static final double kAlgaeIntakeI = 0.0;
      public static final double kAlgaeIntakeD = 0.0;
    }

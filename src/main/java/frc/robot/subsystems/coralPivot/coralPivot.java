...
public class CoralPivot extends SubsystemBase {
    ...
    public CoralPivot(CoralPivotIO io) {
        ...
        SysId = new SysIdRoutine(
            new SysIdRoutine.Config(Volts.per(Second).of(CoralPivotConstants.RAMP_RATE), Volts.of(CoralPivotConstants.STEP_VOLTAGE), null),
    ...
    public void periodic() {
        ...
        Logger.recordOutput("CoralPivot/PivotAbsoluteEncoderConnected", inputs.angleRads != CoralPivotConstants.CORAL_PIVOT_OFFSET);
    }
    ...
    public void addPID(double setpointAdd) {
        ...
        this.setpoint = MathUtil.clamp(this.setpoint, CoralPivotConstants.CORAL_PIVOT_MIN_ANGLE, CoralPivotConstants.CORAL_PIVOT_MAX_ANGLE);
        
        Logger.recordOutput("CoralPivot/Setpoint", setpoint);
    }

    public boolean atSetpoint() {
        return Math.abs(io.getAngle() - setpoint) < CoralPivotConstants.CORAL_PIVOT_PID_TOLERANCE && Math.abs(getVelocity()) < CoralPivotConstants.CORAL_PIVOT_PID_VELOCITY_TOLERANCE;
    }
    ...
    public Command quasistaticForward() {
        return SysId
            ...
            .until(() -> getAngle().getRadians() > CoralPivotConstants.CORAL_PIVOT_MAX_ANGLE)
                .alongWith(new InstantCommand(() -> Logger.recordOutput("CoralPivot/sysid-test-state-", "quasistatic-forward")));
      }
    ...
    public Command quasistaticBack() {
        return SysId
            ...
            .until(() -> getAngle().getRadians() < CoralPivotConstants.CORAL_PIVOT_MIN_ANGLE)
                .alongWith(new InstantCommand(() -> Logger.recordOutput("CoralPivot/sysid-test-state-", "quasistatic-reverse")));
    }
    ...
    public Command dynamicForward() {
        return SysId
            ...
            .until(() -> getAngle().getRadians() > CoralPivotConstants.CORAL_PIVOT_MAX_ANGLE)
                .alongWith(new InstantCommand(() -> Logger.recordOutput("CoralPivot/sysid-test-state-", "dynamic-forward")));
    }
    ...
    public Command dynamicBack() {
        return SysId
            ...
            .until(() -> getAngle().getRadians() < CoralPivotConstants.CORAL_PIVOT_MIN_ANGLE)
                .alongWith(new InstantCommand(() -> Logger.recordOutput("CoralPivot/sysid-test-state-", "dynamic-reverse")));
    }
